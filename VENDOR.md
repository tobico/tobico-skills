...
| `grilling` | `skills/productivity/grilling/` | `8b14ca97479f518f3f1ced6a35bf591554d7e0cb` | **modified** — uses the question/reply labelling grammar, now extracted to the repo-level `QUESTION-GRAMMAR.md` and referenced via a synced copy |
